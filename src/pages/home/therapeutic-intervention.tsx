...
export default function TherapeuticInterventionSection() {
    return (
        <section id="therapeutic-intervention" className='grid grid-cols-2 justify-center'>
            <div className='items-center justify-start max-w-[39rem] flex flex-col gap-20'>
            ...
            <div className='grid grid-cols-2 grid-rows-2 gap-20'>
                <div className='flex flex-col max-w-[18.75rem] gap-10'>
